...
<p>
    <a href="{{ env('MAIN_URL') }}/about-us/creative-commons-licensing" title="Creative commons explained">Creative
        commons explained</a> - what it means, how you can use our's and other
    people's content.
</p>
