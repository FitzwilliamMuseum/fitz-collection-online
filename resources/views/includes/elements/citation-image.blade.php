<div class="mb-2">
    ...
    <div class="bg-grey p-3 rounded">
        ...
        <code id="harvardData">
            ...
            "{{ $exif->getHeadline() ?? $object['title'][0]['value'] ?? ucfirst($object['summary_title']) }}"
...
<div class="mb-3">
    ...
    <div class="bg-grey p-3 rounded">
        ...
        <code id="wikiData">
            ...
            |title={{ $exif->getHeadline() ?? $object['title'][0]['value'] ?? ucfirst($object['summary_title']) }}
...
<div class="mb-3">
    ...
    <div class="bg-grey p-3 rounded">
        ...
        <code id="apiCode">{{ route('api.images.show',$object['multimedia'][0]['admin']['id']) }}</code>
...
@if(array_key_exists('multimedia', $object ))
    @if(array_key_exists('processed', $object['multimedia'][0]))
        @include('includes.elements.bootstrap-code-image')
    @endif
@endif
