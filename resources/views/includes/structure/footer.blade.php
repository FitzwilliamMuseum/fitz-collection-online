        ...
        <div class="col-sm mt-2 mb-2">
          ...
          <ul class="share">
            <li><a href="https://www.museums.cam.ac.uk/"
              ...
              <li><a href="{{ env('MAIN_URL') }}/about-us/terms-of-use"
                aria-label="Website terms and conditions">Website Terms of Use</a></li>
                <li><a href="{{ env('MAIN_URL') }}/about-us/privacy-and-cookies">Cookies, privacy & accessibility</a></li>
                <li>
                  <a aria-label="Contact the museum" href="{{ env('MAIN_URL') }}/about-us/contact-us">Contact us</a>
                </li>
                <li>
            ...
            <div class="col-sm mt-2 mb-2">
              ...
              <p class="share">
                ...
                <a aria-label="Fitzwilliam Museum github account" href="https://www.github.com/fitzwilliammuseum/"><i
            ...
            <div class="col-sm mt-2 mb-2">
              ...
              <ul class="share">
                ...
                <li>Content: CC-BY</li>
                <li>Code: AGPL | <a href="https://github.com/fitzwilliammuseum/collection-online">Repo</a></li>
              </ul>
            </div>
          </div>
        </div>
