...
<h3>Example connected records (with images)</h3>
    <div class="row">
    ...
    <div class="col-md-4 mb-3">
      <div class="card h-100 ">
        ...
        @if(array_key_exists('multimedia', $record['_source']))
          <a href="/id/object/{{ $record['_source']['identifier'][1]['priref']}}"><img class="img-fluid mx-auto d-block embed-responsive-item" src="https://api.fitz.ms/mediaLib/{{ $record['_source']['multimedia'][0]['processed']['preview']['location'] }}"
